...
(function(global) {
	...
	global.addEventListener('DOMContentLoaded', () => {
		...
		const figure = doc.querySelector('section#about figure#avatar');
		...
		const sounds = (function() {
			...
			if (audio === true) {
				...
				burp   = new Audio('/design/about/avatar/burp.'   + ext);
				melody = new Audio('/design/about/avatar/melody.' + ext);
				ouch   = new Audio('/design/about/avatar/ouch.'   + ext);
				vomit  = new Audio('/design/about/avatar/vomit.'  + ext);
